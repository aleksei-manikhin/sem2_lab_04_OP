...
Я уже писал практически идентичную работу, но используя принципы ООП и язык c++, тут мы пишем на языке C и без ООП. Вот ссылка на репозиторий с лабораторной работой на C++ от туда у нас точно будет добавлен ui и mainwindow и drag and drop и touchpad, ну и в целом можешь на неё опираться: https://github.com/aleksei-manikhin/sem2_lab_04_OOP.git Также для примерного понимания как писать лабораторные работы на си и как реализовывать единую точку входа прилагаю ещё одну ссылку на репозиторий с другой лабораторной работой на си, на которую также можно опираться: https://github.com/aleksei-manikhin/sem2_lab_03_OP.git 
